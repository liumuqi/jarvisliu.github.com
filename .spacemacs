...
This function should only modify configuration layer settings."
  (setq mlayer-layer-packages '(vdiff))
  (defun mlayer/init-vdiff ()
    (use-package vdiff
      :defer t))
  (setq-default
